    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                String nomortelfn = "tel:0853-56919389";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(nomortelfn));

            } else if (pilihan.equals("SMS Center"))
            {
                String smsText="Anggi Vasella/P";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:085335304647"));
            ...
            {
                String website ="http://bppsdmk.kemkes.go.id/info_sdmk/info/fasyankes?unit=1471135";
